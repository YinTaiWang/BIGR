'''
This script is for copying image files of the ones that have done the segmentation to assigned folder. 
'''
...
if __name__ == "__main__":
    #####################
    ### Set the paths ###    # Change if needed #
    #####################
    root_dir = os.getcwd()
    os.chdir('..')
    root_dir = os.getcwd()
    ...
    dest_img_dir = os.path.join(root_dir, "data","BLT_radiomics")
    dest_seg_dir = os.path.join(root_dir, "data","BLT_radiomics","mask")
