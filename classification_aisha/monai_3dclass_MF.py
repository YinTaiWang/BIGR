...
from monai.networks.nets import resnet50, resnet101
...
# split train and val
train, val = sklearn.model_selection.train_test_split(data, test_size = 0.2, random_state=24, stratify=labels)
...
#model = resnet50(n_input_channels=3, num_classes=2)
#print(model.summary())
