...
if __name__ == '__main__':
    ...
    for epoch in range(max_epochs):
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            if (epoch+1) % 10 == 0:
                ...
                save_model_path = csv_name[:-4] + "_model.pth"
    ...
    if gradcam == True:
      ...
      #plt.imshow(blend)
      plt.figure("image_gradcam", (5, 5))
      plt.imshow(img2d, cmap = 'gray')
      plt.imshow(result, cmap = 'rainbow', alpha = 0.5)
      plt.colorbar()
      plt.savefig('/trinity/home/agoedhart/Data/Plots/grad_img_fold_' + str(n+1))
      
      if use_seg == True:
        plt.figure("image_seg", (5, 5))
        plt.imshow(img2d, cmap = 'gray')
        plt.imshow(seg2d, cmap = 'winter', alpha = 0.5*(seg2d>0))
        #blend_img = blend_images(image=img2d, label=seg2d, alpha=0.5, rescale_arrays=False)
        #plt.imshow(blend)
        plt.savefig('/trinity/home/agoedhart/Data/Plots/seg_img_fold_' + str(n+1))
        ...
        #blend_img = blend_images(image=img2d, label=seg2d, alpha=0.5, rescale_arrays=False)
        #plt.imshow(blend)
        plt.savefig('/trinity/home/agoedhart/Data/Plots/seg_grad_fold_' + str(n+1))
