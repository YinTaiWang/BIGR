...
##################### DATA ######################################
# labels
print('Half T2 (label 0) and half portal venous (label 1)')
#label_path = "/trinity/home/agoedhart/Classification/labels_CHECK.csv" #CHECK
label_path = "/trinity/home/agoedhart/Classification/labels_all_phases_NEW.csv"
df_label = pd.read_csv(label_path)
#df_label = df_label[["Patient", "Malignant"]]
#df_label.to_csv("/trinity/home/agoedhart/Classification/labels_CHECK2.csv")


#data_dir = "/trinity/home/agoedhart/Data/ScansCHECK/" #CHECK
data_dir = "/trinity/home/agoedhart/Data/Scans"
img_name = 'ph2_bbox.nii.gz' #CHECK
seg_name = 'ph2_bbox_seg.nii.gz' #CHECK

images = sorted(glob.glob(os.path.join(data_dir,'*',img_name)))
segmentations = sorted(glob.glob(os.path.join(data_dir,'*',seg_name)))
...
max_epochs = 400
# Name of plot figure
exp_name = '_RN10_unfrozen_CHECK_real'
...
#    plt.savefig('/trinity/home/agoedhart/Data/Plots/training_data_TEST.png')
