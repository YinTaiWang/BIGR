...
max_epochs = 100
# Name of plot figure
fig_name = '/trinity/home/agoedhart/Data/Plots/Masked/plots_CV_' + str(n+1) + '_rn10_unfrozen_Review_CE.png'
#fig_name = '/trinity/home/agoedhart/Data/Plots/plots_test.png'
auc_fig = '/trinity/home/agoedhart/Data/Plots/auc_CV_' + str(n+1) + '_rn10_unfrozen_Review_CE.png'
csv_path = '/trinity/home/agoedhart/Data/rn10_unfrozen_Review_CE' + str(n+1) + '.csv'
print(fig_name)
###################### Pretraining weights ###############################
...
if __name__ == '__main__':
    ...
    if architecture == 'Classifier':
        model = Classifier(in_shape=[1, 192, 160, 96], classes=n_classes, channels=(8, 16, 16, 32), 
