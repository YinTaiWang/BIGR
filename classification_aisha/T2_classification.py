...
from monai.transforms import EnsureChannelFirstd, MapTransform, ScaleIntensityd, RandZoomd
...
##################### DATA ######################################
# labels
label_path = "/trinity/home/agoedhart/Classification/labels_all_T2.csv"
df_label = pd.read_csv(label_path)
df_label['Malignant'] = df_label['Malignant'].astype('int')
print(df_label.Patient[0])

# images and segmentations
data_dir = "/trinity/home/agoedhart/Data/ScansT2"
images = sorted(glob.glob(os.path.join(data_dir,'*','image_bbox.nii.gz')))
segmentations = sorted(glob.glob(os.path.join(data_dir,'*', 'mask_bbox.nii.gz')))
...
max_epochs = 300
# Name of plot figure
fig_name = '/trinity/home/agoedhart/Data/Plots/Masked/plots_CV_' + str(n+1) + '_T2.png'
#fig_name = '/trinity/home/agoedhart/Data/Plots/plots_test.png'
auc_fig = '/trinity/home/agoedhart/Data/Plots/auc_CV_' + str(n+1) + '_T2.png'
print(fig_name)
###################### Pretraining weights ###############################
...
if __name__ == '__main__':
    ...
    if architecture == 'Classifier':
        model = Classifier(in_shape=[1, 240, 240, 36], classes=2, channels=(8, 16, 16, 32), 
    ...
    df = pd.DataFrame(list(zip(epoch_loss_values, val_loss_values, metric_values_train, metric_values, auc_values)),
               columns =['train loss', 'test loss', 'train acc', 'test acc', 'test auc'])
    df.to_csv(csv_path)  
